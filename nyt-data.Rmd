...
## -name is telling it to make it long for all columns except name; can also use without the minus to tell it to include data
## quotes are because the column doesn't exist yet and we're telling it to create those
```{r}
